...
//   ESP32 -> PC   : {"zone1":<0-100>,"temperature":<C>,"humidity":<%>,"pulseZone":"<A1-A4>","nozzleStatus":"..."}
...
void sendSensorReading() {
  ...
  // Which zone the shared pump/servo is currently aimed at — lets the PC
  // bridge attribute pulse feedback to the right zone instead of assuming
  // it always matches the soil-probe zone (zone1/A1).
  json += ",\"pulseZone\":\"" + pulseZone + "\"";
